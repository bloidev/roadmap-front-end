...
export default function ThemeToggle(){
    ...
    useEffect(() => {
        let _theme : any = window.localStorage.getItem('theme')
    ...
    return (
        <label className={`relative m-0 block h-7 w-14 rounded-full bg-slate-500`}>
            <input 
                className="dur absolute top-0 z-50 m-0 h-full w-full cursor-pointer opacity-0"
                type="checkbox"
                onChange={handleChange}
                checked={Boolean(theme == "dark" ? true: false)}
            />   
